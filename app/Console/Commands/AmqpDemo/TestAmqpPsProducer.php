...
class TestAmqpPsProducer extends BaseCommand
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test:amqp-ps-producer {msg=hello...}';
     ...
     * @var string
     */
    protected $description = 'amqp publish subscribe test producer';
